...
Concerning _models_, split the business logic by sets of models belonging to a same main
...
- in the `_auto_init()` method of an _models.Model_ object: this is taken care of by the
